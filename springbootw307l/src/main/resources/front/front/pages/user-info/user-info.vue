<template>
	<view class="content">
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='yonghuxinxi'" class="cu-form-group">
		...
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='yonghuxinxi'" class="cu-form-group">
			...
			<view v-if="tableName=='yonghuxinxi'" :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#ccc","margin":"0","borderWidth":"0 0 2rpx 0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
		...
		<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.3)","borderColor":"rgba(242, 241, 241, 1)","margin":"0 0 0px 0","borderStyle":"solid","borderWidth":"0 0 2rpx 0","height":"108rpx"}' v-if="tableName=='yonghuxinxi'" @tap="yonghuxinxitouxiangTap" class="cu-form-group" :class="left == 'left'?'':'active'">
	...
	export default {
		...
		async onLoad() {
			...
			if(this.tableName=='yonghuxinxi'){
				...
				this.yonghuxinxixingbieOptions.forEach((item, index) => {
					if(item==this.ruleForm.xingbie) {
						this.yonghuxinxixingbieIndex = index;
					}
				});
			}
			this.styleChange()
