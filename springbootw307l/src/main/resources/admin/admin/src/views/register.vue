  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(106, 0, 138, 0.47);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 247, 247, 1);fontSize:28px;">云匹面粉直供微信小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			<!-- <div v-if="tableName=='yonghuxinxi'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='yonghuxinxi'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yonghuxinxi'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='yonghuxinxi'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='yonghuxinxi'">
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='yonghuxinxi'">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='yonghuxinxi'">
